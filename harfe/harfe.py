...
def harfe(b,c0 = None,s = None,tot_iter = None,thresh = None,mu = None,lam = None):
    ...
    **HARFE**
    ...
    S^{n+1} = {s largest entry indices of (1-mu*m*lam)*c^n + mu A^*(b - A c^n) }
